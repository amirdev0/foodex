...
int addUserInfo(enum foodex_user_type_e user_type, const char *name, const char *phone, const char *address, const char *delivery_type, const char *password);

//Retrieves account information with specific phone.
int getUserInfo(struct foodex_user_t user);
